export function startsWith(text, startsWith) {
    var undef = undefined;
...
export function normalizeString(str) {
    var result = '';
    var val = str.toString(); // In case 'str' is a numeric value
    for (var i = 0; i < val.length; ++i) {
        // Passer chaque cles et remplacer dans la chaine
        var converted = diacriticsMap[val.charAt(i).toLowerCase().charCodeAt(0)];
