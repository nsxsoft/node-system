import { ENGLISH } from '../utils/i18n/i18n';
var EnglishPlugin = {
    install: function (v, options) {
        ...
        if (i18n) {
            ...
            msgs.forEach(function (msgs) { return i18n.addMessages(ENGLISH, msgs); });
        }
        else {
            throw new Error('EnglishPlugin.install -> You must use the i18n plugin.');
        }
    }
};
